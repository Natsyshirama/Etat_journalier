<template>
  <div class="t24-card-upload">
    ...
    <!-- Formulaire d'import -->
    <v-card class="mb-4">
      <v-card-title>Import T24 Card</v-card-title>
      <v-card-text>
        <v-container>
          <!-- Date Selection -->
          <v-row>
    ...
    <v-card class="info-card">
      ...
      <v-card-text class="text-caption">
        <ul>
          ...
          <li>Le nom doit suivre le format: <code>t24_YYYYMMDD.csv</code></li>
          <li>Exemple: <code>t24_20260705.csv</code></li>
          <li>Colonnes attendues: Num Compte Credit, creditAmount, processingDate, L.AT.PAN.NO, L.AT.RRN, Compte DB Cions, Saisi le</li>
        </ul>
      </v-card-text>
    </v-card>
  </div>
...
import { useT24CardImport } from '../../composables/useT24import'
